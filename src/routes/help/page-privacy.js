      ...
      <main-layout> 
          ...
          <article>
                <section>
                    ...
                    <p><strong>You Control Your Content.</strong> [[env.siteName]] is a web-based platform ([[env.webAddress]]) (“Site”) offering a suite of tools for users to optimize their experience.</p>
                    ...
                    <p>We may use third-party advertising companies to serve ads when you visit our Site. These companies may use information (not including your&nbsp;name, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you. We may collect user activity in our analytics platform, including personal information of individual users, but only for internal Site usage analysis.</p>
                    ...
                    <p><strong>It Helps Us Provide Better Service to You.</strong> We use your personal information to:</p>
                    <ul>
                    ...
                    <p>You have the option to receive a full export of data [[env.siteName]] has stored about you. To do this please send us an email notifying us of your request of an export to <a href="mailto:[[env.exportEmail]]">[[env.exportEmail]]</a>.</p>
