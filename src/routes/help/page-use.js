...
class PageUse extends ReduxMixin(PolymerElement) {
  static get template() {
    ...
    <section>
        ...
        <p>[[env.siteName]] is a web-based platform ([[env.webAddress]]) (“Site”) offering a suite of tools for users (“users”) to optimize their experience and their engagement and transactions with their followers (“Followers”) (“Service”). To preserve the positive experience of all our users, Followers and visitors (collectively, “Users”), you agree that you will use the Service only in a manner consistent with the following Acceptable Use Policy.</p>
        <p><strong>You agree not to use the Service to post or display User Content that:</strong></p>
        <ul>
        ...
        <ul>
            <li>Use, display, mirror or frame the Service, any individual element within the Service, the [[env.siteName]] name, trademark, logo or other proprietary information, or the layout and design of any page, without our express written consent;</li>
            ...
            <li>Avoid, bypass, remove, deactivate, impair, descramble or otherwise circumvent any technological measure implemented by [[env.siteName]] or any of our providers or any other third party (including another user) to protect the Service or [[env.siteName]] Content;</li>
            <li>Attempt to access or search the Service, User Content or [[env.siteName]] Content or scrape or download User Content or [[env.siteName]] Content from the Service, or otherwise use, upload content to, or create new links, reposts, or referrals in the Service through the use of any engine, software, tool, agent, device or mechanism (including automated scripts, spiders, robots, crawlers, data mining tools or the like) other than the software and/or search agents provided by [[env.siteName]] or other generally available third party web browsers;</li>
            <li>Use any meta tags or other hidden text or metadata utilizing a [[env.siteName]] or [[env.siteName]] trademark, logo, URL, or product name without [[env.siteName]]’s express written consent;</li>
            <li>Use the Service for any commercial purpose or the benefit of any third party, except as otherwise explicitly permitted for you by [[env.siteName]] or in any manner not permitted by the Terms;</li>
            <li>Attempt to decipher, decompile, disassemble or reverse engineer any of the software used to provide the Service;</li>
            <li>Interfere with, or attempt to interfere with, the access of any user, host or network, including, without limitation, sending a virus, overloading, flooding, spamming, or mail-bombing the Service;</li>
            <li>Collect or store any personally identifiable information from the Service from other users of the Service without their express permission;</li>
        ...
        <p>[[env.siteName]] reserves the right, but is not obligated, to remove any User Content for any reason or for no reason, including User Content that [[env.siteName]] believes violates this Acceptable Use Policy or its Terms of Service. [[env.siteName]] may also permanently or temporarily terminate or suspend a User’s access to the Service without notice and liability for any reason, including if, in [[env.siteName]]’s sole determination, a User violates any provision of this Acceptable Use Policy , our <a href="/help/terms">Terms of Service</a>, or for no reason.</p>
    </section>
</article>
          </div>
      </main-layout>
